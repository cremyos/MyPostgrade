...
for i = 1:PrintHang
    fprintf(fidout, '%d %f %d\n', TrainClass(i, PrintLie), TrainData(i, PrintLie), Y_OutPut(i, PrintLie));
end
fclose(fidout);
...
for i = 1:PrintTestHang
    fprintf(fidout, '%d %f %d\n', TestClass(i, PrintTestLie), TestData(i, PrintTestLie), yReal_OutPut(i, PrintTestLie));
end
fclose(fidout);
